...
<html>
	...
	<body id='login-body' class="bg-light">
        ...
        <div class="card col-md-6 offset-md-3 text-center bg-primary mb-4">
            <h3 class="he3-responsive text-white">Welcome To Quiz System</h3>
        </div>
		<div class="card col-md-4 offset-md-4 mt-4">
            ...
            <div class="card-body">
                     <form id="login-frm" autocomplete="off">
                        ...
                        <div class="form-group text-right">
                            ...
                            <a style="margin-right:155px;text-decoration:none;" href="admin.php">Admin Login</a>
                        </div>
